...
const Projects = () => {
    return (
        <section id="projects" className="text-point-jean">
            <h2 className="text-3xl font-gtk">Projects</h2>
            <div className="flex flex-col gap-10">
                {PROJECTS.items.map((project, index) => (
                    ...
                    >
                        {/* 왼쪽: 이미지 */}
                        <div className="relative flex-roww-40 h-30 overflow-auto">
                            <Image
                                src={project.image}
                                alt={project.title}
                                objectFit="contain"
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-point-blue font-mono group-hover:text-base-khaki transition-colors duration-300">
                                {project.description}
                            </p>
                        </div>
