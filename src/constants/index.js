import about from "../assets/img/godard.jpg";
import port01 from "../assets/img/godard.jpg";
...
export const projectText = [
    {
        ...
        code: "https://github.com/doomangang/minishell",
        view: "",
        info: [
            "stack : C",
        ],
    ...
    {
        text: ["MiniRT"],
        title: "shy ray tracing renderer",
        code: "https://github.com/doomangang/minirt",
        view: ".",
        info: [
            "stack : C",
        ],
    ...
    {
        text: ["Mindeye"],
        title: "Real-time object detection and pedestrian navigation",
        code: "https://github.com/doomangang/mindeye",
        view: ".",
        info: [
            "use stack : React Native, Tmap API",
        ],
    },
];
